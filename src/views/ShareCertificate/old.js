...
export default function ShareCertificate() {
  ...
  return (
    <div className={classes.root}>
      <Accordion>
        <AccordionSummary expandIcon={<ExpandMoreIcon htmlColor="white" />} id="panel1a-header" className={classes.summary} classes={classes}>
        ...
        <AccordionDetails>
          <div className="w-100">
            <div>
              <TwoPartTableWithTitle title={c1certTitle} certPart1={c1certPart1} certPart2={c1certPart2}></TwoPartTableWithTitle>
            </div>
            <div className="mt-3">
