...
import { Box, Button, FormControl, Grid, InputLabel, makeStyles, MenuItem, Paper, Select, TextField, ThemeProvider, Typography } from "@material-ui/core";
...
export default function ProfileForm() {
  ...
  return (
    <div>
      ...
      <Typography>Chỉnh sửa lại thông tin cá nhân (nếu cần)</Typography>
      {/* row 1 */}
      <Paper>
        <Box p={3} className={cls.box}>
